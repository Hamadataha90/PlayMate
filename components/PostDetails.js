    ...
    <div className="group flex flex-col cursor-pointer bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-lg border border-gray-100 dark:border-gray-700 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
      ...
      <div className="p-7 flex flex-col grow relative bg-white dark:bg-gray-800 z-10">
        ...
        <div className="mb-4 flex flex-wrap items-center gap-2">
          {post?.game && (
            <span className="px-3 py-1 rounded-full text-xs font-bold bg-blue-100 text-blue-800 dark:bg-blue-900/40 dark:text-blue-300 shadow-sm border border-blue-200 dark:border-blue-800">
              {post.game}
            </span>
          )}
          {post?.location && (
        ...
        <div className="mt-6 pt-5 border-t border-gray-100 dark:border-gray-700/50 flex justify-between items-center">
          <button className="flex items-center gap-1.5 text-sm font-black text-blue-600 dark:text-blue-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors cursor-pointer">
            Read Article
          ...
          {formattedDate && (
            <span className="flex items-center text-xs font-semibold text-gray-400 dark:text-gray-500">
